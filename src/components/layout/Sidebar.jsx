...
function Sidebar({ isOpen, onNavigate }) {
  return (
    <aside
      id="app-sidebar"
      aria-label="Primary"
      className={`fixed inset-y-0 left-0 z-40 w-64 max-w-full transform border-r border-slate-200 bg-white pt-16 transition-transform duration-200 ease-in-out
